...
// Fetch user ID (vulnerable: no session hardening)
if ($user) {
...
// Fetch balance (correct table: accounts)
$bal = 0;
...
<div class="max-w-4xl mx-auto p-6">
  <div class="bg-white dark:bg-gray-800 p-6 rounded shadow">
    ...
    <div class="grid grid-cols-2 gap-4 mt-6">
      <a href="transfer.php" class="block bg-blue-600 text-white p-3 rounded text-center">Make Transfer</a>
      <a href="statement.php" class="block bg-green-600 text-white p-3 rounded text-center">View Statement</a>
      <a href="upload.php" class="block bg-purple-600 text-white p-3 rounded text-center">Upload File</a>
      <a href="blog.php" class="block bg-yellow-500 text-white p-3 rounded text-center">Blog</a>
    </div>
